...
$resolutions   = array(1280,900,640,480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "henley-edition/wp-content/uploads/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
